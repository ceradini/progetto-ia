...
\end{table}
	...
	\hypertarget{header-n284}{%
		...
		Il codice sorgente dell'applicazione è reperibile sulla repository GitHub al seguente link: \url{http://github.com/bmxitalia
		/ProgettoIA}.
	...
	L'applicazione web è disponibile al seguente link: \url{http://progettoiaunipd.altervista.org/index.php}.
